...
- `require_torch_cuda` - as `require_torch` plus requires at least 1 GPU
- `require_torch_multi_cuda` - as `require_torch` plus requires at least 2 GPUs
- `require_torch_non_multi_cuda` - as `require_torch` plus requires 0 or 1 GPUs
- `require_torch_up_to_2_cudas` - as `require_torch` plus requires 0 or 1 or 2 GPUs
